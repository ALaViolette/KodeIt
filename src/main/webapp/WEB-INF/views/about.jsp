...
<!-- <style>
body {
        background-image:url("http://www.allmobilematters.com/wp-content/uploads/2014/03/ipadminiairfrontcamera.png");
}
</style> -->
...
<p> Select a language from the Question page, and post your question.</p>
